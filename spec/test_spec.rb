...
# let(:bike_class) {double :bike_class}
...
#       expect{6.times { station.dock(bike_class) }}.to raise_error 'dock at maximum capacity'
#     end
#     it 'fails when maximum capacity is reached' do
#       station = DockingStation.new(7)
#       7.times {station.dock(bike_class)}
#       expect{station.dock(bike_class)}.to raise_error 'dock at maximum capacity'
#     end
...
#       bike1 = bike_class
#       bike2 = bike_class 
#       allow(bike_class).to receive(:report_broken).and_return(false)
#       bike2.report_broken
#       subject.dock(bike1)
#       subject.dock(bike2)
#       allow(bike_class).to receive(:working?).and_return(false)
...
#       subject.capacity.times { subject.dock(bike_class) }
#       expect{ subject.dock(bike_class)}.to raise_error 'dock at maximum capacity'
#     end
